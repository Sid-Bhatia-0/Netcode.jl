...
const SIZE_OF_EXTENDED_SEQUENCE_NUMBER_NONCE = 12
...
const PACKET_TYPE_CONNECTION_DENIED_PACKET = TYPE_OF_PACKET_TYPE(1)
const SIZE_OF_CONNECTION_DENIED_PACKET_CONTENT = 0

const PACKET_TYPE_CONNECTION_CHALLENGE_PACKET = TYPE_OF_PACKET_TYPE(2)
const SIZE_OF_CONNECTION_CHALLENGE_PACKET_CONTENT = 308

const PACKET_TYPE_CONNECTION_CHALLENGE_RESPONSE_PACKET = TYPE_OF_PACKET_TYPE(3)
const SIZE_OF_CONNECTION_CHALLENGE_RESPONSE_PACKET_CONTENT = 308

const PACKET_TYPE_CONNECTION_KEEP_ALIVE_PACKET = TYPE_OF_PACKET_TYPE(4)
const SIZE_OF_CONNECTION_KEEP_ALIVE_PACKET_CONTENT = 8

const PACKET_TYPE_CONNECTION_PAYLOAD_PACKET = TYPE_OF_PACKET_TYPE(5)
const MAX_SIZE_OF_CONNECTION_PAYLOAD_PACKET_CONTENT = 1200

const PACKET_TYPE_CONNECTION_DISCONNECT_PACKET = TYPE_OF_PACKET_TYPE(6)
const SIZE_OF_CONNECTION_DISCONNECT_PACKET_CONTENT = 0

const MAX_PACKET_TYPE = TYPE_OF_PACKET_TYPE(6)
